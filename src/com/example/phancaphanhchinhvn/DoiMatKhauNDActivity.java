...
public class DoiMatKhauNDActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_doi_mat_khau_nd);
		...
		editTextSuaMatKhau=(EditText)findViewById(R.id.editTextDoiMatKhauNDMoi);
		editTextXNMatKhau=(EditText)findViewById(R.id.editTextDoiXNMatKhauNDMoi);
		...
		buttonCapNhat=(Button)findViewById(R.id.buttonDoiMatKhauNDMoi);
				...
				try {
					if (json.getString("success") != null) {
						...
						if (json.getString("success").equals("1")) {							
							...
							((DoiMatKhauNDActivity) arg0.getContext()).finish();
							Intent themtinh=new Intent(DoiMatKhauNDActivity.this,TrangChuActivity.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.doi_mat_khau_nd, menu);
		return true;
	}
